...
func Test_ReadInt_RejectsTooLargeNumber(t *testing.T) {
	badInputs := []string{
...
func Test_ReadInt_RejectsInvalidInput(t *testing.T) {
	badInputs := []string{
		// Bad prefix
		"a+1",
		"+++",
...
func Test_ReadString_RejectsInvalidInput(t *testing.T) {
	badInputs := []string{
		// Bad prefix
		"a+1",
		"+++",
